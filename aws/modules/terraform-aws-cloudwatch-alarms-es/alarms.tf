...
resource "aws_cloudwatch_metric_alarm" "cluster_status_is_red" {
  ...
  alarm_name                = "${var.alarm_name_prefix}-ElasticSearch-${var.alarm_name_postfix}-ClusterStatusIsRed"
...
resource "aws_cloudwatch_metric_alarm" "cluster_status_is_yellow" {
  ...
  alarm_name                = "${var.alarm_name_prefix}-ElasticSearch-${var.alarm_name_postfix}-ClusterStatusIsYellow"
  comparison_operator       = "GreaterThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "free_storage_space_too_low" {
  ...
  alarm_name                = "${var.alarm_name_prefix}-ElasticSearch-${var.alarm_name_postfix}-FreeStorageSpaceTooLow"
...
resource "aws_cloudwatch_metric_alarm" "free_storage_space_total_too_low" {
  ...
  alarm_name                = "${var.alarm_name_prefix}-ElasticSearch-${var.alarm_name_postfix}-FreeStorageSpaceTotalTooLow"
  comparison_operator       = "LessThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "cluster_index_writes_blocked" {
  ...
  alarm_name                = "${var.alarm_name_prefix}-ElasticSearch-${var.alarm_name_postfix}-ClusterIndexWritesBlocked"
  comparison_operator       = "GreaterThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "insufficient_available_nodes" {
  ...
  alarm_name                = "${var.alarm_name_prefix}-ElasticSearch-${var.alarm_name_postfix}-InsufficientAvailableNodes"
...
resource "aws_cloudwatch_metric_alarm" "automated_snapshot_failure" {
  ...
  alarm_name                = "${var.alarm_name_prefix}-ElasticSearch-${var.alarm_name_postfix}-AutomatedSnapshotFailure"
  comparison_operator       = "GreaterThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "cpu_utilization_too_high" {
  ...
  alarm_name                = "${var.alarm_name_prefix}-ElasticSearch-${var.alarm_name_postfix}-CPUUtilizationTooHigh"
  comparison_operator       = "GreaterThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "jvm_memory_pressure_too_high" {
  ...
  alarm_name                = "${var.alarm_name_prefix}-ElasticSearch-${var.alarm_name_postfix}-JVMMemoryPressure"
  comparison_operator       = "GreaterThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "master_cpu_utilization_too_high" {
  ...
  alarm_name                = "${var.alarm_name_prefix}-ElasticSearch-${var.alarm_name_postfix}-MasterCPUUtilizationTooHigh"
  comparison_operator       = "GreaterThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "master_jvm_memory_pressure_too_high" {
  ...
  alarm_name                = "${var.alarm_name_prefix}-ElasticSearch-${var.alarm_name_postfix}-MasterJVMMemoryPressure"
  comparison_operator       = "GreaterThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "kms_key_error" {
  ...
  alarm_name                = "${var.alarm_name_prefix}-ElasticSearch-${var.alarm_name_postfix}-KMSKeyError"
  comparison_operator       = "GreaterThanOrEqualToThreshold"
...
resource "aws_cloudwatch_metric_alarm" "kms_key_inaccessible" {
  count                     = var.monitor_kms ? 1 : 0
  alarm_name                = "${var.alarm_name_prefix}-ElasticSearch-${var.alarm_name_postfix}-KMSKeyInaccessible"
  comparison_operator       = "GreaterThanOrEqualToThreshold"
  evaluation_periods        = var.alarm_kms_periods
  datapoints_to_alarm       = var.alarm_kms_periods
